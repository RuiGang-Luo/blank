...
module.exports = {
   ...
   */
  // entry: ['babel-polyfill',path.join(__dirname, 'build/index.js')],
  ...
  devServer: {
    ...
    proxy: {
      ...
      [(process.env.VUE_APP_PUBLIC_PATH === '/' ? '' : process.env.VUE_APP_PUBLIC_PATH) + process.env.API_BUSINESS_PROXY_CONTEXT]: {
        ...
        changeOrigin: true,
        pathRewrite: {
          ['^' + (process.env.VUE_APP_PUBLIC_PATH === '/' ? '' : process.env.VUE_APP_PUBLIC_PATH) + process.env.API_BUSINESS_PROXY_CONTEXT]: process.env.API_BUSINESS_CONTEXT
        }
      },
      [(process.env.VUE_APP_PUBLIC_PATH === '/' ? '' : process.env.VUE_APP_PUBLIC_PATH) + process.env.API_CORE_PROXY_CONTEXT]: {
        target: proxy_core,
        changeOrigin: true,
        pathRewrite: {
          ['^' + (process.env.VUE_APP_PUBLIC_PATH === '/' ? '' : process.env.VUE_APP_PUBLIC_PATH) + process.env.API_CORE_PROXY_CONTEXT]: process.env.API_CORE_CONTEXT
        }
      }
    },
  ...
  configureWebpack: {
    ...
    module: {
      ...
      rules: [
        {
          test: /(calcTextareaHeight\.js|mixins\\emitter\.js|mixins\\migrating\.js|utils\\types\.js|element-ui\\src\\utils\\util\.js)/,
          use: 'babel-loader'
